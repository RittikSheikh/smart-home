...
<div className="flex flex-col w-full justify-center p-6 shadow-md sm:px-12 dark:bg-gray-900 dark:text-gray-100">
	<img src={me} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
	<div className="space-y-4 text-center divide-y divide-gray-700">
		<div className="my-2 space-y-1">
			<h2 className="text-xl font-semibold sm:text-2xl">Rittik Sheikh</h2>
			<p className="px-5 text-xs sm:text-base dark:text-gray-400">Front-End developer</p>
		</div>
		<div className="flex justify-center pt-2 space-x-4 align-center">
			<a rel="noopener noreferrer" href="https://github.com/RittikSheikh" target='blank' aria-label="GitHub" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
			...
			<a rel="noopener noreferrer" href="https://twitter.com/home" target='blank' aria-label="Twitter" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
			...
			<a rel="noopener noreferrer" href="https://www.facebook.com/profile.php?id=100022681518432" target={'blank'} aria-label="Email" className="p-2 rounded-md dark:text-gray-100 hover:dark:text-violet-400">
				<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
